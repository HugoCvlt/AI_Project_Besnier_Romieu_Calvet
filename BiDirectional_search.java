...
public class BiDirectional_search {
    ...
    public State_set explored_s;
    public ArrayList<SearchNode> frontier_t; // end state
    public State_set explored_t;

    public BiDirectional_search(Board root) throws Exception{
        ...
        this.explored_s = new State_set(); // set of searchNodes
        this.frontier_t = new ArrayList<SearchNode>(); // FIFO
        this.explored_t = new State_set();
    }
